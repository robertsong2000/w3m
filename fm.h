...
#endif				/* USE_DICT */
#ifdef USE_GOOGLE
#define GOOGLEBUFFERNAME "*google*"
#endif				/* USE_GOOGLE */
#ifdef USE_GOOGLE_LUCKY
#define GOOGLELUCKYBUFFERNAME "*googlelucky*"
#endif				/* USE_GOOGLELUCKY */
...
#endif				/* USE_DICT */
#ifdef USE_GOOGLE
global int UseGoogleCommand init(FALSE);
global char *GoogleCommand init("file:///$LIB/w3mgoogle" CGI_EXTENSION);
#endif				/* USE_GOOGLE */
#ifdef USE_GOOGLE_LUCKY
global int UseGoogleLuckyCommand init(FALSE);
global char *GoogleLuckyCommand init("file:///$LIB/w3mgooglelucky" CGI_EXTENSION);
